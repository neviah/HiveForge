...
`, 'utf-8');
    ...
    if (!fs.existsSync(jsPath)) {
      fs.writeFileSync(jsPath, `const suits = ["♠", "♥", "♦", "♣"];
...
`, 'utf-8');
    ...
    if (!fs.existsSync(readmePath)) {
      fs.writeFileSync(readmePath, `# Solitaire MVP Scaffold
...
- This is the baseline playable scaffold used to enforce real artifact output.
